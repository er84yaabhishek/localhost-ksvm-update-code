...
@include('frontend.partials.page_banner', ['title' => 'Examination — '.$exam->exam_for, 'breadcrumb' => 'Exam Details'])
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="detail-card">
                    <div class="detail-badge">Examination For — {{ $exam->exam_for }}</div>
                    ...
                    <div class="mt-4 d-flex gap-3 flex-wrap">
                        <a href="{{ route('home.exam') }}" class="btn-ksvm-outline">
