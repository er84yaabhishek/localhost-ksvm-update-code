        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item">Why Choose Us</li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title mb-0">Why Choose Us Items</h4>
                                <p class="card-category mb-0">Home page par "Why Choose Us" section ke cards</p>
                            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="fas fa-plus-circle"></i> Add Why Choose Us Item</h5>
            ...
            <form id="addForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="addTitle" class="form-control" placeholder="e.g. Safe Environment">
...
$(document).ready(function() {
    ...
    var STORE_URL  = '{{ route("admin.homepage.why.store") }}';
    var BASE_URL   = '{{ url("admin/homepage/why-choose-us") }}';
