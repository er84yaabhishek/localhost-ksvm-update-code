    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">What We Provide</h4>
                <ul class="breadcrumbs">
                    <li class="nav-home"><a href="{{ route('admin.dashboard') }}"><i class="flaticon-home"></i></a></li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item">Home Page</li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item">What We Provide</li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title mb-0">What We Provide Items</h4>
                                <p class="card-category mb-0">Home page par "What We Provide" section ke cards</p>
                            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title"><i class="fas fa-plus-circle"></i> Add What We Provide Item</h5>
            ...
            <form id="addForm">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="addTitle" class="form-control" placeholder="e.g. Our Mission">
...
$(document).ready(function() {
    ...
    var STORE_URL  = '{{ route("admin.homepage.provide.store") }}';
    var BASE_URL   = '{{ url("admin/homepage/what-we-provide") }}';
