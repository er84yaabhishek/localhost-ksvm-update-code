        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">Add Admission News</h4>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title d-inline-block">Add Admission News</div>
                                <a class="btn btn-info btn-sm float-right d-inline-block" href="">
                            ...
                            <div class="card-body pt-5 pb-5">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <form id="ajaxForm" class="" action="{{ route('admin.admission.store') }}"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="admission_for"
                                                            value="" placeholder="Enter admission Year">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
            ...
            $('#ajaxForm').submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        bootnotify('Admission Added Successfully!', 'Admission Add!', 'success');
                    ...
                    error: function (xhr) {
                        ...
                        if (errors) {
                            $.each(errors, function (key, value) {
                                ...
                                bootnotify(value[0], 'Admission Add!', 'danger')
                            });
                        }
                    }
                });
