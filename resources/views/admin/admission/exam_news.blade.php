        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">Examination News</h4>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="card-title d-inline-block">Examination News</div>
                                    </div>
                                            ...
                                            <table class="table table-striped mt-3" id="basic-datatables">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">Examination For</th>
                                                ...
                                                <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-info btn-sm"
                                                                        href="{{ route('admin.exam.edit', $news->id)}}">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <form class="d-inline-block"
                                                                        action="{{ route('admin.exam.delete') }}"
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="5" class="text-center">No Examination news found.</td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                                            </table>
        ...
        function changeStatus(val, id) {
            $.ajax({
                ...
                success: function (response) {
                    bootnotify('Examination Status Updated Successfully!', 'Examination Status!', 'success');
                    loadWindow();
                },
                error: function (xhr) {
                    ...
                    if (xhr.responseJSON && xhr.responseJSON.errors) {
                        $.each(xhr.responseJSON.errors, function (key, value) {
                            bootnotify(value[0], 'Examination Status!', 'danger');
                        });
                    } else {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        hideConfirmModal();
                        bootnotify('Examination Delete Successfully!', 'Examination Delete!', 'success');
                        loadWindow();
                    }
                },
                error: function (xhr, status, error) {
                    bootnotify('Falied Examination Delete', 'Examination Delete!', 'danger')
                }
            });
        }
    </script>
