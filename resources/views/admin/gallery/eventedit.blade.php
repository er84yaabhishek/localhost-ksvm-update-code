                            ...
                            <div class="card-body pt-5 pb-5">
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <form id="ajaxForm" class="" action="{{ route('admin.event.update', $event->id) }}"
                                            method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="px-2">
                                               <input type="hidden" name="id" value="{{ $event->id }}">
                                                 <label for="" class="mb-2"><strong>Images **</strong></label>
                                                 <img src="{{ public_asset('storage/event/' . $event->image) }}" alt="{{ $event->title }}" class="img-fluid mb-3" style="max-height: 200px; object-fit: cover;">
                                                <div class="fallback">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="description" name="description"
                                                            placeholder="Enter description" data-height="300">{{ $event->description }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
            ...
            $('#ajaxForm').submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        bootnotify('Event Update Successfully!', 'Event Update!', 'success');
                    ...
                    error: function (xhr) {
                        ...
                        if (errors) {
                            $.each(errors, function (key, value) {
                                ...
                                bootnotify(value[0], 'Event Update!', 'danger')
                            });
                        }
                    }
                });
